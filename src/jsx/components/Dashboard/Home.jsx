...
const AreaChart2Canvas = loadable(() => pMinDelay(import("./Elements/AreaChart2Canvas"), 1000));
const ChartWidget2 = loadable(() => pMinDelay(import("./Elements/ChartWidget2"), 1000));
const ShareProfitCanvas2 = loadable(() => pMinDelay(import("./Elements/ShareProfitCanvas2"), 1000));
const ActiveUserCanvas = loadable(() => pMinDelay(import("./Elements/ActiveUserCanvas"), 1000));

const sampleData = [6, 2, 8, 4, 3, 8, 4, 3, 6, 5, 9, 2];

const Home = () => {
  const { changeBackground, changeSideBarStyle, chnageSidebarColor, changeNavigationHader } = useContext(ThemeContext);
  useEffect(() => {
  ...
  return (
    <div className="row">
      ...
      <div className="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
        <div className="card activity_overview">
          <div className="card-header  border-0 pb-3 ">
            <h4 className="card-title mb-4">재방문율</h4>
          </div>
          <div className="m-2">
            <RevisitBarCoupon />
          </div>
      ...
      <div className="col-xl-3 col-xxl-4 col-lg-6 col-md-6">
        <div className="card activity_overview">
          <div className="card-header  border-0 pb-3 ">
            <h4 className="card-title mb-4">이벤트 효과</h4>
          </div>
          <div className="m-2">
            <RevisitBarSales />
          </div>
